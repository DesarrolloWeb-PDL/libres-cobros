...
interface InstitutionCustomizationProps {
  club: {
    id: string;
    name: string;
    logoUrl?: string | null;
...
export function InstitutionCustomization({ club }: InstitutionCustomizationProps) {
  ...
  async function handleLogoUpload(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      setLogo(data.url);
      toast.add({ title: 'Logo actualizado', description: 'El logo de la institución se actualizó correctamente', type: 'success' });
    } catch {
  ...
  async function handleSave() {
    ...
    try {
      ...
      toast.add({ title: 'Guardado', description: 'La personalización de la institución se guardó correctamente', type: 'success' });
    } catch {
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Subí el logo o escudo de tu institución. Se mostrará en el portal de socios.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex items-start gap-6">
            ...
            <div className="flex size-24 items-center justify-center rounded-xl border-2 border-dashed border-border bg-muted/30">
              {logo ? (
                <Image src={logo} alt="Logo de la institución" width={96} height={96} className="size-full object-contain p-2" />
              ) : (
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Personalizá los colores que identifican a tu institución.
          </CardDescription>
        </CardHeader>
