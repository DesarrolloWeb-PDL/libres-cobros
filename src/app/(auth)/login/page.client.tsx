...
export default function LoginPageClient({ primaryColor }: LoginPageClientProps) {
    ...
    <div className="flex min-h-screen items-center justify-center bg-muted/30 p-4">
      <div className="w-full max-w-sm space-y-6">
        <div className="flex flex-col items-center gap-3">
          <Logo size={64} showScroll={false} color={primaryColor} />
        ...
        <Card>
          <CardHeader className="text-center">
            <CardTitle style={accentStyle}>Iniciar Sesión</CardTitle>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" className="w-full" disabled={isLoading} style={btnStyle}>
